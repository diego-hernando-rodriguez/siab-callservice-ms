...
public class ConfiguracionController {
    ...
    public ResponseEntity<ApiResponse<DescriptorDTO>> getDescriptor(
        ...
        switch (tipo.toUpperCase()) {
            ...
            case "PRODUCTO": descripcion = descriptorService.getDescriptorProducto(ramo != null ? ramo : 0, Integer.parseInt(codigo)); break;
            case "CAUSA": descripcion = descriptorService.getDescriptorCausa(ramo != null ? ramo : 0, producto != null ? producto : 0, Long.parseLong(codigo)); break;
